...
namespace PRG5.CSharpCity.LLTravel.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddSingleton<ICountryRepository, CountryRepositoryREST>();

            // Or we use a JSON file with all data in it
            services.AddSingleton<ICountryRepository, CountryRepositoryFile>();
